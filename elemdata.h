...
/*
;*******************************************************************************
;* Extended types (marine & custom) - lines                                    *
;*******************************************************************************
...
static const struct elem_info_struct marine_polyline_data[] = {
  0x0100,	"misc line",
  0x0101,	"line",
  ...
  0x0405,	"supply pipeline",
  0x0406,	"submarine cable",
  ...
  0x0506,	"limit of nature reservat",
  ...
  0x0e00,	"custom line 1",
  0x0e01,	"custom line 2",
  0x0e02,	"custom line 3",
  0x0e03,	"custom line 4",
  0x0e04,	"custom line 5",
  0x0e05,	"custom line 6",
  0x0e06,	"custom line 7",
  0x0e07,	"custom line 8",
  0x0e08,	"custom line 9",
  0x0e09,	"custom line a",
  0x0e0a,	"custom line b",
  0x0e0b,	"custom line c",
  0x0e0c,	"custom line d",
  0x0e0d,	"custom line e",
  0x0e0e,	"custom line f",
  0x0e0f,	"custom line 10",
  0x0e10,	"custom line 11",
  0x0e11,	"custom line 12",
  0x0e12,	"custom line 13",
  0x0e13,	"custom line 14",
  0x0e14,	"custom line 15",
  0x0e15,	"custom line 16",
  0x0e16,	"custom line 17",
  0x0e17,	"custom line 18",
  0x0e18,	"custom line 19",
  0x0e19,	"custom line 1b",
  0x0e1a,	"custom line 1b",
  0x0e1b,	"custom line 1c",
  0x0e1c,	"custom line 1d",
  0x0e1d,	"custom line 1e",
  0x0e1e,	"custom line 1f",
  0x0e1f,	"custom line 20",
  0x0f00,	"custom line 21",
  0x0f01,	"custom line 22",
  0x0f02,	"custom line 23",
  0x0f03,	"custom line 24",
  0x0f04,	"custom line 25",
  0x0f05,	"custom line 26",
  0x0f06,	"custom line 27",
  0x0f07,	"custom line 28",
  0x0f08,	"custom line 29",
  0x0f09,	"custom line 2a",
  0x0f0a,	"custom line 2b",
  0x0f0b,	"custom line 2c",
  0x0f0c,	"custom line 2d",
  0x0f0d,	"custom line 2e",
  0x0f0e,	"custom line 2f",
  0x0f0f,	"custom line 30",
  0x0f10,	"custom line 31",
  0x0f11,	"custom line 32",
  0x0f12,	"custom line 33",
  0x0f13,	"custom line 34",
  0x0f14,	"custom line 35",
  0x0f15,	"custom line 36",
  0x0f16,	"custom line 37",
  0x0f17,	"custom line 38",
  0x0f18,	"custom line 39",
  0x0f19,	"custom line 3b",
  0x0f1a,	"custom line 3b",
  0x0f1b,	"custom line 3c",
  0x0f1c,	"custom line 3d",
  0x0f1d,	"custom line 3e",
  0x0f1e,	"custom line 3f",
  0x0f1f,	"custom line 40",
  0, 0
};

/*
;*******************************************************************************
;* Extended types (marine & custom) - areas                                    *
;*******************************************************************************
...
static const struct elem_info_struct marine_polygon_data[] = {
  0x0100,	"land - white",
  ...
  0x0506,	"limit of nature reservat (invisible)",
  ...
  0x0609,	"depth area",
  0x0701,	"fishing area ",
  0x0704,	"map background area",

  0x0f00,	"custom area 1",
  0x0f01,	"custom area 2",
  0x0f02,	"custom area 3",
  0x0f03,	"custom area 4",
  0x0f04,	"custom area 5",
  0x0f05,	"custom area 6",
  0x0f06,	"custom area 7",
  0x0f07,	"custom area 8",
  0x0f08,	"custom area 9",
  0x0f09,	"custom area 10",
  0x0f0a,	"custom area 11",
  0x0f0b,	"custom area 12",
  0x0f0c,	"custom area 13",
  0x0f0d,	"custom area 14",
  0x0f0e,	"custom area 15",
  0x0f0f,	"custom area 16",
  0x0f10,	"custom area 17",
  0x0f11,	"custom area 18",
  0x0f12,	"custom area 19",
  0x0f13,	"custom area 20",
  0x0f14,	"custom area 21",
  0x0f15,	"custom area 22",
  0x0f16,	"custom area 23",
  0x0f17,	"custom area 24",
  0x0f18,	"custom area 25",
  0x0f19,	"custom area 26",
  0x0f1a,	"custom area 27",
  0x0f1b,	"custom area 28",
  0x0f1c,	"custom area 29",
  0x0f1d,	"custom area 30",
  0x0f1e,	"custom area 31",
  0x0f1f,	"custom area 32",
  0x1000,	"custom area 33",
  0x1001,	"custom area 34",
  0x1002,	"custom area 35",
  0x1003,	"custom area 36",
  0x1004,	"custom area 37",
  0x1005,	"custom area 38",
  0x1006,	"custom area 39",
  0x1007,	"custom area 40",
  0x1008,	"custom area 41",
  0x1009,	"custom area 42",
  0x100a,	"custom area 43",
  0x100b,	"custom area 44",
  0x100c,	"custom area 45",
  0x100d,	"custom area 46",
  0x100e,	"custom area 47",
  0x100f,	"custom area 48",
  0x1010,	"custom area 49",
  0x1011,	"custom area 50",
  0x1012,	"custom area 51",
  0x1013,	"custom area 52",
  0x1014,	"custom area 53",
  0x1015,	"custom area 54",
  0x1016,	"custom area 55",
  0x1017,	"custom area 56",
  0x1018,	"custom area 57",
  0x1019,	"custom area 58",
  0x101a,	"custom area 59",
  0x101b,	"custom area 60",
  0x101c,	"custom area 61",
  0x101d,	"custom area 62",
  0x101e,	"custom area 63",
  0x101f,	"custom area 64",
  0, 0
};
